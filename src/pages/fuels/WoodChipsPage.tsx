      ...
      <section className="bg-primary-800 text-white py-24">
        <div className="container-custom">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">{woodChips.name}</h1>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-600">{woodChips.calorificValue} kcal/kg</p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-800">Type</h3>
                  <p className="text-gray-600">{woodChips.type}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section">
        <div className="container-custom text-center">
          ...
          <p className="section-subtitle">
            Contact us to discuss your wood chip requirements and get a customized quote.
          </p>
